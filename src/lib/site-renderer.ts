...
function nav(activePage: ActivePage): string {
  ...
  return `<header class="topbar"><nav class="nav"><a class="brandmark" href="/models/"><span class="logo"></span><span>mddb.dev</span></a><div class="topSearch">⌕ Search</div><div class="navlinks"><span class="disabled" aria-disabled="true">模型动态</span><a${modelsClass} href="/models/">模型广场</a></div></nav></header>`
}
