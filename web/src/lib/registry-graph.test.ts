...
describe('registry graph adapter', () => {
  ...
  it('renders the current plaza, provider, and detail UI from the new registry graph', () => {
    ...
    expect(openRouterEndpointDetail).toContain('<h1>OpenRouter: Solar Pro 3</h1>')
    expect(openRouterEndpointDetail).toContain('<title>OpenRouter: Solar Pro 3 · mddb.dev</title>')
    ...
    expect(palmyraOpenRouterDetail).toContain('<h1>OpenRouter: Palmyra X5</h1>')
  })
})
